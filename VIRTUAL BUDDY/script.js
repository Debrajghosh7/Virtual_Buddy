...
function takeCommand(message){
    ...
    if(message.toLowerCase().includes("hello")||message.toLowerCase().includes("hey")){
        ...
        speak("I am your virtual buddy created by Debraj Sir");
        ...
        let finalText="this is what i got on internet regarding" + message.replace("Ryan","")||message.replace("Rian","")
        speak(finalText)
        window.open(`https://www.google.com/search?q=${message.replace("Ryan","")}`)
    }
}